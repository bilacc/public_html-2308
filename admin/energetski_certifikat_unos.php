<?php 
	...
	$crud = new Admin_Crud;
	$crud->table = 'energetski_certifikat';
...
?>
	...
	{
	?>
		<h1>Uređivanje energetskih certifikata <br/><a href="<?php echo $crud->table; ?>_unos.php" class="gumb">Dodaj novi</a></h1>
	<?php
	}else{
	?>
		<h1>Unos energetskih certifikata</h1>
	<?php } ?>
