<?php 
	...
	$show['url'] = true; 			//podnaslov
	$show['text'] = false; 				//tekst
	...
	$crud->files_titles =  false; 	
	if(($_GET['id']==1) || ($_GET['id']==6) || ($_GET['id']==7)){
		$crud->img_num = 2; 
	}else{
		$crud->img_num = 0; 
	}
	...
	$cat = new Admin_ManageCategories($data['id'],'city', $crud->table);
...
?>
	...
	{
	?>
		<h1>Uređivanje gradova <br/><a href="<?php echo $crud->table; ?>_unos.php" class="gumb">Dodaj novi</a></h1>
	<?php
	}else{
	?>
		<h1>Unos gradova</h1>
	...
	<form name="<?php echo $crud->table; ?>" id="<?php echo $crud->table; ?>" class="unos" action="" enctype="multipart/form-data" method="post">
		...
		<?php/*<div class="box-25 light">			
			<div class="right-tabs">
				<h3>Gumb</h3>
				<a href="javascript:;" id="right_tab2_en"><span>EN</span></a>
				<a href="javascript:;" id="right_tab1_hr" class="active-right"><span>HR</span></a>
			</div>
				<div class="clearfix">	</div>

			<h4>Boja gumba</h4>
			<select name="button_color" id="button_color">
				<option value="crvena" <?php echo ($data['button_color'] == 'crvena')? 'selected="selected"':'';?>>Crvena</option>
				<option value="plava" <?php echo ($data['button_color'] == 'plava')? 'selected="selected"':'';?>>Plava</option>
				<option value="zelena" <?php echo ($data['button_color'] == 'zelena')? 'selected="selected"':'';?>>Zelena</option>
				<option value="tirkizna" <?php echo ($data['button_color'] == 'tirkizna')? 'selected="selected"':'';?>>Svijetlo zelena</option>
				<option value="narancasta" <?php echo ($data['button_color'] == 'narancasta')? 'selected="selected"':'';?>>Narancasta</option>
				<option value="roza" <?php echo ($data['button_color'] == 'roza')? 'selected="selected"':'';?>>Roza</option>
			</select>

			<div class="right-tabs-container active-right" id="right_tab1_hr_container">
				<h4>Tekst gumba</h4>
				<input type="text" name="button_hr" id="button_hr" value="<?php echo $data['button_hr']; ?>"/>
				<h4>Link</h4>
				<input type="text" name="link_hr" id="link_hr" value="<?php echo $data['link_hr']; ?>"/>
			</div>
			<div class="right-tabs-container" id="right_tab2_en_container">
				<h4>Tekst gumba</h4>
				<input type="text" name="button_en" id="button_en" value="<?php echo $data['button_en']; ?>"/>
				<h4>Link</h4>
				<input type="text" name="link_en" id="link_en" value="<?php echo $data['link_en']; ?>"/>
			</div>
		</div>*/?>
		...
		<?php 
			...
			<select name="parent_id" id="parent_id">
				...
				?>
					<option value="<?php echo $red['id']?>" <?php echo ($data['parent_id'] == $red['id'])? 'selected="selected"':'';?>>
					...
					?>
						<option value="<?php echo $sub_red['id']?>" <?php echo ($data['parent_id'] == $sub_red['id'])? 'selected="selected"':'';?>>
						...
						?>
							<option value="<?php echo $subsub_red['id']?>" <?php echo ($data['parent_id'] == $subsub_red['id'])? 'selected="selected"':'';?>>
							...
							?>
							<option value="<?php echo $subsubsub_red['id']?>" <?php echo ($data['parent_id'] == $subsubsub_red['id'])? 'selected="selected"':'';?>>
