<?php 
	...
	$cat = new Admin_ManageCategories($data['id'],'city');
?>
	<h1>Pregled komentara <br/><a href="<?php echo $table; ?>_unos.php" class="gumb">Dodaj novi</a></h1>
			...
			if($data){
				...
				?>
					<tr id="row_<?php echo $v['id']; ?>">
						<td class="naslov">
							<a href="<?php echo $table; ?>_unos.php?action=update&id=<?php echo $v['id']; ?>"><?php echo $v['autor_hr']; ?></a>
							<div class="opcije">
