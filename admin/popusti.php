<?php 
	...
	$crud->files_num = false; 			// broj fajlova koje unosimo, za neograničeno upiši: null
	...
	$crud->img_titles = true; 			// dali slike trebaju naslov
	...
	<form name="<?php echo $crud->table; ?>" id="<?php echo $crud->table; ?>" class="unos" action="" enctype="multipart/form-data" method="post">
		...
		<div class="box-75">
			...
			if($show['title'])
			{
				...
				{
				?>
					<label for="title_hr">Naziv linka</label>
