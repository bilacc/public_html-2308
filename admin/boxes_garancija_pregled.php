...
?>
	<h1>Pregled boxeva <br/><a href="<?php echo $table; ?>_unos.php" class="gumb">Dodaj novi</a></h1>
			...
			if($data){
				...
				?>
					<tr id="row_<?php echo $v['id']; ?>">
						...
						<td class="slika"><a href="<?php echo $table; ?>_unos.php?action=update&id=<?php echo $v['id']; ?>"><img src="<?php echo _SITE_URL; ?>lib/plugins/thumb.php?src=<?php echo _SITE_URL.$slika; ?>&w=40&h=40&zc=1" alt="" /></a></td>
					</tr>
				<?php
				}
			}else{
