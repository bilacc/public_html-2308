<?php 
	...
	$crud = new Admin_Crud;
	$crud->table = 'komentari';
	$crud->title_row_name = 'title_hr';
	
	$show['title'] = true; 				//naslov
	$show['url'] = true; 			//podnaslov
	$show['text'] = false; 				//tekst
	$show['front_page'] = true; 		//izdvajanje na naslovnicu ili gdje se već poveže na frontu
...
?>
	...
	{
	?>
		<h1>Uređivanje komentara <br/><a href="<?php echo $crud->table; ?>_unos.php" class="gumb">Dodaj novi</a></h1>
	<?php
	}else{
	?>
		...
		?>
			...
			<div class="tabs-title-content">
					<div class="editor-title slc" id="tab_title_hr_content">
						...
						<input type="text" placeholder="Email" name="email" id="email" value="<?php echo $data['email']; ?>"/>
					</div>
